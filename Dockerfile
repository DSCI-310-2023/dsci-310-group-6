...
RUN Rscript -e "install.packages(c('readxl','digest','repr','tidymodels','GGally', 'here', 'devtools'))"
...
RUN Rscript -e "devtools::install_github('DSCI-310/dsci-310-group-6-pkg')"
