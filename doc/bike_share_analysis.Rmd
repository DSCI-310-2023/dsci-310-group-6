...
data <- read_csv("../data/clean_data.csv")     # read the data and unselect some useless columns
...
```{r, echo = FALSE, message = FALSE}
training <- read_csv('../data/training_data.csv')
testing <- read_csv('../data/testing_data.csv')
source("../src/find_k_min.R")
```
```{r, echo = FALSE, message = FALSE}
k_list <- find_k_min(training)
recipe = k_list[[1]]
kmin = k_list[[3]]
```
```{r, echo = FALSE, message = FALSE}
